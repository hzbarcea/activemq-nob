...
public interface BrokerFilenameEncoder {
     ...
     * @return path to the metadata file for the broker with this given ID, even
     ...
     * @return path to the xbean file for the broker with this given ID, even if
     * the broker does not exist.
     */
    File locateBrokerXbeanFilePath(String brokerId);

    /**
     * Locate the properties file for the broker with the specified ID.
     *
     * @param brokerId of the broker for which to locate the metadata file.
     * @return path to the properties file for the broker with this given ID, even
     * if the broker does not exist.
     */
    File locateBrokerPropertiesFilePath(String brokerId);
}
