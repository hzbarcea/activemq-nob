...
public interface BrokerFilenameDecoder {
    /**
     * Extract the ID of the broker from the file at the given path.  The file may be a directory or a regular file.
     *
     * @param brokerPath path to the candidate broker.
     * @return ID of the broker at that path, if the path is a valid broker path.
     */
